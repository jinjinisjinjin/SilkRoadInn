...
const bandRules = {
  quick: { min: 10, max: 27, ideal: 20, minLevel: 1, maxLevel: 3 },
  regular: { min: 47, max: 83, ideal: 73, minLevel: 2, maxLevel: 5 },
  goal: { min: 183, max: 333, ideal: 273, minLevel: 4, maxLevel: 8 },
};
