const config = {
  ...
  overlayRoot: ".",
  repairs: [
    { file: "overlay-01.webp", targets: [[780, 170, 240], [1250, 200, 180]] },
    { file: "overlay-02.webp", targets: [[400, 800, 260], [180, 430, 160]] },
    { file: "overlay-03.webp", targets: [[790, 620, 110], [1040, 620, 110]] },
    { file: "overlay-04.webp", targets: [[890, 520, 210]] },
    { file: "overlay-05.webp", targets: [[1360, 460, 180]] },
    { file: "overlay-06.webp", targets: [[420, 560, 150]] },
    { file: "overlay-07.webp", targets: [[1320, 760, 190], [540, 650, 140]] },
    { file: "overlay-08.webp", targets: [[800, 500, 100], [1040, 500, 100]] },
    { file: "overlay-09.webp", targets: [[620, 195, 100]] },
  ],
};
...
const embeddedRepairId = new URLSearchParams(location.search).get("repairId") || "04";
